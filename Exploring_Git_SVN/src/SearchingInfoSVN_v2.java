...
public class SearchingInfoSVN_v2 {
	...
	public static void main(String args[]) throws IOException{
		...
		File f1 = new File("commitsLogSvn_VFSBrowser_java.txt");
		File f2 = new File("commitsLogSvn_Buffer_java.txt");
		File f3 = new File("commitsLogSvn_TextArea_java.txt");
		File f4 = new File("commitsLogSvn_EditPane_java.txt");
		File f5 = new File("commitsLogSvn_View_java.txt");
		File f6 = new File("commitsLogSvn_GUIUtilities_java.txt");
		File f7 = new File("commitsLogSvn_SearchAndReplace_java.txt");
		File f8 = new File("commitsLogSvn_StandaloneTextArea_java.txt");
		File f9 = new File("commitsLogSvn_JEditBuffer_java.txt");
		
		File f10 = new File("commitsLogSvn_ActionSet_java.txt");
		File f11 = new File("commitsLogSvn_Macros_java.txt");
		
		FileWriter fw1 = new FileWriter(f1, false);
		FileWriter fw2 = new FileWriter(f2, false);
		FileWriter fw3 = new FileWriter(f3, false);
		FileWriter fw4 = new FileWriter(f4, false);
		FileWriter fw5 = new FileWriter(f5, false);
		FileWriter fw6 = new FileWriter(f6, false);
		FileWriter fw7 = new FileWriter(f7, false);
		FileWriter fw8 = new FileWriter(f8, false);
		FileWriter fw9 = new FileWriter(f9, false);
		
		FileWriter fw10 = new FileWriter(f10, false);
		FileWriter fw11 = new FileWriter(f11, false);
		...
		//HashMap<String, String> compsAndRevisions = new HashMap<String, String>();
		 ...
		 DAVRepositoryFactory.setup( );
			...
			//String url = "https://jmol.svn.sourceforge.net/svnroot/jmol";
		 	...
		 	//String url = "https://freecol.svn.sourceforge.net/svnroot/freecol";
	            ...
	            for ( Iterator entries = logEntries.iterator( ); entries.hasNext( ); ) {
	                ...
	                if ( logEntry.getChangedPaths( ).size( ) > 0 ) {
	                    ...
	                    for ( Iterator changedPaths = changedPathsSet.iterator( ); changedPaths.hasNext( ); ) {
	                        ...
	                        if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/browser/VFSBrowser.java"))
	                        	fw1.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/Buffer.java"))
	                        	fw2.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/textarea/TextArea.java"))
	                        	fw3.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/EditPane.java"))
	                        	fw4.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/View.java"))
	                        	fw5.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/GUIUtilities.java"))
	                        	fw6.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/search/SearchAndReplace.java"))
	                        	fw7.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/textarea/StandaloneTextArea.java"))
	                        	fw8.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/buffer/JEditBuffer.java"))
	                        	fw9.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/ActionSet.java"))
	                        	fw10.write(logMsg+'\n');
	                        else if (entryPath.getPath().equals("/jEdit/trunk/org/gjt/sp/jedit/Macros.java"))
	                        	fw11.write(logMsg+'\n');
